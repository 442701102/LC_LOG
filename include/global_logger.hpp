...
#if defined(USE_CUSTOM_LOGGER)
#include "Module/custom/LC_custom.h"
#define Derived customLogLogger
...
void init(const std::string& config_file="") {
    ...
    if(config_file.empty()) {
        ConfigLoader::GetInstance().createDefaultConfig(ConfigLoader::default_config);
    } else {
        ConfigLoader::GetInstance().LoadConfig(config_file);    
    }
