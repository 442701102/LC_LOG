...
# build_armv7.sh
# 需要调整 DEFAULT_HOST_PROFILE="profile_ag35_armv7" 为自己的配置文件,该文件在主目录的profiles文件夹下
...
DEFAULT_HOST_PROFILE="profile_ag35_armv7"
DEFAULT_ACTION="all"
DEFAULT_CONANFILE=""

# 帮助信息函数
show_help() {
    echo "Usage: $0 [action] [conanfile] [hostprofile] [test]"
